...
const rainyCrops = [
  {
    name: 'Aman Rice',
    description: 'A variety of rice grown in the rainy season.',
    image: 'https://source.unsplash.com/300x200/?rice-field',
  },
  {
    name: 'Vegetables',
    description: 'Various vegetables are grown during the rainy season.',
    image: 'https://source.unsplash.com/300x200/?vegetable',
  },
  {
    name: 'Jute',
    description: 'A fiber plant cultivated in the rainy season.',
...
function RainyPage() {
  ...
  const filteredCrops = rainyCrops.filter(crop =>
